            ...
            <div class="banner">
                <div class="contents-head">
                   <div class="head-letter" style="margin-top: 4%;">
                    <p style="color: rgb(137,203,49);margin-left: 5%; font-family: rgb(51, 51, 51);"><span style="font-size: 60px;color: rgb(196,173,101);">S</span>olemio Cusvoice</p>
                        <p style="margin-top: -3%;margin-left: 5%;    color: rgb(137,203,49);"><span style="font-size: 60px;color: rgb(196,173,101);">고</span>객의소리</p>
                    <div class="tree-bar" style="width: 100%;height: 24px;">
                        ...
                        <button id="cusvoice-write" type="button" style="float: right;margin-top: -6%;">등록</button>
                    </div>
                    </div>
                </div>
