...
<html>
<head>
     <link rel="stylesheet" href="resources/css/stake.css">
     <meta charset="utf-8">
           ...
           <div id="left-fixed">
            ...
            <div class="banner">
                <div class="contents-head">
                    ...
                    <p style="color: rgb(137,203,49);margin-left: 5%; font-family: rgb(51, 51, 51);"><span style="font-size: 60px;color: rgb(196,173,101);">S</span>olemio Pizza</p>
                        <p style="margin-top: -3%;margin-left: 5%;    color: rgb(137,203,49);"><span style="font-size: 60px;color: rgb(196,173,101);">피</span>자</p>
