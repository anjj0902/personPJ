            ...
            <div class="banner">
                <div class="contents-head">
                    ...
                    <div class="head-letter">
                        <p><span>회</span>원정보수정</p>
                    </div>
                </div>
                <div class="contents-middle">
                   <div class="member-update">
                       <div class="member-update-contents1"></div>
                       <div class="member-update-contents2">
                          <div class="update-contents-first"></div>
                          <div class="update-contents-second">
                              <span style="font-family: 'Nanum Brush Script', serif; font-size: 20px;margin-top: 20px;margin-left: 42px;">비밀번호 : </span><input type="text" class="passinput"style="margin-left: 30px;" name="text"><br><br>
                            <span style="font-family: 'Nanum Brush Script', serif;font-size: 20px;margin-left: 42px;">비밀번호 확인 : </span><input class="passcominput"type="text" name="text"><br><br>
                            <span style="font-family: 'Nanum Brush Script', serif;font-size: 20px;margin-left: 42px;">이메일 : </span><input class="email" type="text" style="margin-left: 38px;"name="text">
                              <button type="button" name="button">확인</button>
                              <button type="button" name="button">취소</button>
                          </div>
                          <div class="update-contents-third"></div>
                          
                           
                       </div>
                       <div class="member-update-contents3"></div>
                   </div>
