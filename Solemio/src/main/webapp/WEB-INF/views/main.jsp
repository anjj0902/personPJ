           ...
           <div id="left-fixed">
            <div class="menu">
                <div class="menu-drop">
                    <div class="menu-drop-logo">
                       <img src="resources/img/KakaoTalk_20171226_135740144.png" style="width: 100%;height: 20%; padding-bottom: 50%;">
            ...
            <div class="preview">
               <div class="interior">
                    ...
                    <div class="interior-img">인테리어</div>
                </div>
                <div class="news">공지사항</div>
                <div class="customer">고객의소리</div>
                <div class="map">매장안내</div>
